...
class FunctionCaller(object):
	...
	def watch_simulation(self, simulation_type: str, config_file: str, eating_number: int) -> None:
		print()
		print(f"Watching simulation")
		simulation_parameters = {
			"brain" : create_brain("watchable-brain", {
		...
		sim = create_simulation("watchable-simulation", simulation_parameters)