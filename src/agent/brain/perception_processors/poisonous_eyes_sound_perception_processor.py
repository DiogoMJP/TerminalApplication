...
class PoisonousEyesSoundPerceptionProcessor(PerceptionProcessor):
	...
	def to_dict(self) -> dict[str, Any]:
		return {
			"type"		: "poisonous-eyes-sound-perception-processor",
	...
	@staticmethod
	def create_from_parameters(params) -> 'PoisonousEyesSoundPerceptionProcessor':
		...
		return PoisonousEyesSoundPerceptionProcessor(params["n-sensors"], params["fov"], params["n-freq"])

	@staticmethod
	def load_from_data(data: dict[str, Any]) -> 'PoisonousEyesSoundPerceptionProcessor':
		return PoisonousEyesSoundPerceptionProcessor(data["n-sensors"], data["fov"], data["n-freq"])