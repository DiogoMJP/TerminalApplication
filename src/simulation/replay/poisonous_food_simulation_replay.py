...
class PoisonousFoodSimulationReplay(SimulationReplay):
	def __init__(
	...
	@staticmethod
	def load_from_data(data: dict[str, Any]) -> 'PoisonousFoodSimulationReplay':
		return PoisonousFoodSimulationReplay(
